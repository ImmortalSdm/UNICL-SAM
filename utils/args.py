...
model_lists = ['gpt', 'sam', 'vrp_qformer_sam', 'vrp_sam', 'vrp_sam_mul', 
               'vrp_sam_dino', 'vrp_sam_con', 'vrp_sam_concat', 'vrp_sam_qr', 
               'vrp_sam_qr_reverse', 'vrp_sam_no_query', 'vrp_sam_cos_sim_reweight', 
               ...
               'vrp_sam_dino_vitdet_fpn_group_cross_attn', 'vrp_sam_dino_vitdet_fpn_cls',
