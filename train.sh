...
CUDA_VISIBLE_DEVICES=9 python -u -m torch.distributed.run --master_port 25001 --nproc_per_node=1 train.py \
    ...
    --data_type sam_seg_imgiter_degrad_contrasive \
...
# sh test.sh 9 experiments/cvpr_2025/00003-vrp_sam_dinov2_large_uncertainty_refine-vrp_sam_dino_uncertainty_graph_deterministic_contrastive-sam_seg_degrad_contrasive-epoch20-batch4-blr0.0001-res518-samples1 19
